...
- Mission Control equilibra el laboratorio de transmisión con un resumen fijo a la izquierda: identidad visual y paleta en vivo, flujo Generar → Transmitir → Verificar, alcance técnico 13/104/78 y una declaración explícita de privacidad local. Por debajo de 1050px vuelve al flujo vertical y permanece contenido en móviles.
