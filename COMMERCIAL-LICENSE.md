...
ParticlePair is source-available under the [PolyForm Noncommercial License 1.0.0](LICENSE). The public repository license grants rights only for purposes allowed by that license. **It grants no commercial-use rights.**

Commercial use is permitted only after the copyright holder, **tianrking**, has issued explicit written authorization or the parties have signed a separate commercial license. The licensee must accept and comply with those written commercial terms before beginning the commercial use.

A valid authorization should identify the licensee and the permitted scope. Repository access, a fork, a deployment, an issue reply, a pull request, a discussion, an unanswered message, or the technical ability to use the software does **not** constitute commercial permission.

Commercial activities that normally require a separate license include:

- integration into a commercial product, paid service, or subscription;
- sale, licensing, monetization, or paid distribution of ParticlePair or a derivative;
- revenue-generating client work, consulting, or contracted delivery;
- internal use that supports the commercial operations of a for-profit business;
- commercial hardware, firmware, mobile applications, desktop applications, SDKs, or hosted APIs;
...
ParticlePair 依据 [PolyForm Noncommercial License 1.0.0](LICENSE) 以源码可用形式提供。公开仓库许可证只授予该许可证允许目的下的权利，**不授予任何商业使用权**。

商业使用只有在版权所有者 **tianrking** 明确签发书面授权，或双方另行签署商业许可证后才被允许。被许可方必须在开始商业使用前接受并遵守该书面商业条款。

有效授权应当能够识别被许可方和允许的使用范围。访问仓库、Fork、部署、Issue 回复、Pull Request、讨论、未回复的消息，或者技术上能够运行本软件，均**不构成商业许可**。

通常需要单独商业许可证的活动包括：

- 集成到商业产品、付费服务或订阅中；
- 销售、许可、商业化或付费分发 ParticlePair 或其衍生作品；
- 创收客户项目、咨询或合同交付；
- 支持营利性企业商业运营的内部使用；
- 商业硬件、固件、移动应用、桌面应用、SDK 或托管 API；
- 面向预期商业部署的营销、演示、试点或评估。

如需申请商业条款，请创建标题为 `Commercial license inquiry` 的 GitHub Issue，且不要在其中包含保密信息；也可以通过仓库所有者的公开 GitHub 主页联系。提出申请或开始协商不等于获得批准，只有在书面授权正式生效后方可开始使用。

本文件是实务说明，不替代或修改 [`LICENSE`](LICENSE)。如有冲突，以许可证正文及双方最终签署或签发的书面商业条款为准。
