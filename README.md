...
- Mission Control balances the long transmitter laboratory with a sticky left-side system overview: live visual identity and palette, Generate → Transmit → Verify flow, current 13/104/78 engineering scope, and an explicit local-first privacy statement. It becomes a normal stacked card below 1050px and stays fully contained on phone widths.
