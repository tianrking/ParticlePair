...
- The deterministic Visual Quality Engine renders a canonical carrier, measures vibrancy, contrast, hue coverage, motion continuity, and a composite grade, then compares an 8×8 color-motion fingerprint against the nearest mode in the same renderer family. The current 50-mode baseline is 63 minimum, 72 average, and 50 minimum distinctness; the audit fails below 60 quality or 40 distinctness.
